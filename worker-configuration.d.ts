/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dce4ef4119484ba1fc6565b6e233a3ca)
// Runtime types generated with workerd@1.20251118.0 2025-08-23 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./dist/_worker.js/index");
  }
  interface Env {
    MICROCMS_API_URL: string;
    MICROCMS_API_KEY: string;
    MICROCMS_API_KEY_RUNTIME: SecretsStoreSecret;
    MICROCMS_API_URL_RUNTIME: SecretsStoreSecret;
    ASSETS: Fetcher;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, "MICROCMS_API_URL" | "MICROCMS_API_KEY">
    > {}
}
